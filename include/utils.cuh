...
constexpr float to_float(int scaled) { return static_cast<float>(scaled) / SCALE; }
__device__ constexpr float to_float_device(int scaled) { return static_cast<float>(scaled) / SCALE; }
#endif
